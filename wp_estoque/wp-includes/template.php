 ...
 *
 * Looks for 'front-page-clientes.php'. The template path is filterable via the
...
function get_front_page_template() {
	$templates = array('front-page-clientes.php');
